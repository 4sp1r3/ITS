...
La tabla \ref{tab:tuning} muestra las combinaciones de parámetros estudiados para hacer el ajuste paramétrico, $f$ corresponde al fitness del mejor individuo encontrado mientras que $f_{AVG}$ al valor promedio de fitness de los mejores individuos de cada ejecución realizada.
