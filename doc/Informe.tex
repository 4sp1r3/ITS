...
ROUTER ----------------------------------------- DISPOSITIVO (señal -50dbM)
   0m                                                10m

La imagen [1] presenta un escenario ideal en donde se tiene linea de visión entre el router transmisor y el dispositivo receptor, ubicados a una distancia de 10m uno del otro. La señal percibida en este ejemplo es de de -50dbM.\\

[IMAGEN 2]

ROUTER --------------------- OBSTÁCULO --------- DISPOSITIVO (señal -80dbM)
   0m                           8m                   10m

La imagen [2] presenta un escenario un poco más realista, en donde la linea de visión se ve obstruida por un obstáculo (e.g. una pared) entre ellos. En este caso las ondas se ven perturbadas y el dispositivo solo percibe una señal de -80dbM.\\

[IMAGEN 3]

ROUTER ----------------------------------------- DISPOSITIVO (señal -80dbM)
   0m                                                12m

La imagen [3] representa lo que el dispositivo percibiría. Una señal de -80dBm será interpretada por él como una distancia entre el transmisor y receptor de 12m en lugar de 10m, pero esto como no es real. El problema de fondo es la imposibilidad de determinar la existencia de obstáculos entre ambos extremos.
...
La imagen [4] muestra el efecto que tiene sobre la estimación de la posición el hecho de considerar la atenuación hacia cada router.
...
Las instancias de prueba consisten en 5 conjuntos con 3, 4, 5, 6 y 7 routers. Cada uno de ellos fue ubicado en el plano de manera aleatoria respecto a un origen de coordenadas arbitrario.\\

La inicialización del dispositivo, como se mencionó antes, también es aleatorea.\\

Además de estos 5 casos de prueba se montó un escenario real con 3 routers ubicados entre 3 y 10 metros de la computadora y se tomaron medidas de las posiciones e intensidades de señal recibidas. A partir de esto se trianguló la computadora con el objetivo de validar la implementación con un caso real.\\
