...
Para realizar la evaluación del algoritmo se usarán 35 instancias de prueba divididas en 7 conjuntos de 3, 5, 7, 10, 20, 50 y 100 routers. Para cada instancia se harán 100 ejecuciones independientes, totalizando 3500 ejecuciones.\\

Para cada caso se reportará: $G$ generación del mejor individuo ($I$), $f$ fitness de $I$, $f_{AVG}$ promedio de fitness de los individuos de $G$, $\sigma_f$ desviación estándar de los individuos de $G$, $t$ tiempo en segundos utilizados para encontrar $I$, $t_{AVG}$ promedio de $t$ para todas las ejecuciones, $\sigma_t$ desviación estándar de $t$ para todas las ejecuciones, $T$ tiempo total de ejecución en segundos, $E$ error real en metros.
...
\hline
\multicolumn{9}{|c|}{3 Routers}\\ \hline
$G$ & $f$ & $f_{AVG}$ & $\sigma_f$ & $t$ & $t_{AVG}$ & $\sigma_t$ & $T$ & $E$ \\ \hline
320 & 0.8010 & 5.5104 & 6.3907 & 0.0125 & 0.0225 & 0.0109 & 3.88 & 2.32 \\
915 & 0.0673 & 3.6614 & 6.0123 & 0.0354 & 0.0253 & 0.0097 & 3.86 & 0.40 \\
580 & 0.1235 & 0.1235 & 0.0000 & 0.0229 & 0.0245 & 0.0096 & 3.93 & 0.47 \\
712 & 0.2488 & 0.2488 & 0.0000 & 0.0275 & 0.0239 & 0.0092 & 3.88 & 1.87 \\
452 & 0.9314 & 0.9844 & 0.0647 & 0.0176 & 0.0193 & 0.0110 & 3.88 & 0.28 \\ \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
\hline
\multicolumn{9}{|c|}{5 Routers}\\ \hline
$G$ & $f$ & $f_{AVG}$ & $\sigma_f$ & $t$ & $t_{AVG}$ & $\sigma_t$ & $T$ & $E$ \\ \hline
385 & 1.5151 & 1.5151 & 0.0000 & 0.0226 & 0.0316 & 0.0154 & 5.91 & 1.96 \\
353 & 3.2720 & 3.2720 & 0.0000 & 0.0210 & 0.0350 & 0.0142 & 5.97 & 1.60 \\
257 & 1.9190 & 1.9190 & 0.0000 & 0.0151 & 0.0295 & 0.0160 & 5.91 & 1.20 \\
869 & 2.0561 & 2.0561 & 0.0000 & 0.0511 & 0.0305 & 0.0156 & 5.93 & 1.78 \\
406 & 1.3183 & 1.6141 & 0.4453 & 0.0236 & 0.0307 & 0.0157 & 5.93 & 2.93 \\ \hline
\end{tabular}
\label{tab:evaluation5}
\newline

\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
\multicolumn{9}{|c|}{7 Routers}\\ \hline
$G$ & $f$ & $f_{AVG}$ & $\sigma_f$ & $t$ & $t_{AVG}$ & $\sigma_t$ & $T$ & $E$ \\ \hline
84 & 1.6373 & 1.6373 & 0.0000 & 0.0068 & 0.0441 & 0.0191 & 8.00 & 0.96 \\
961 & 1.0254 & 1.0254 & 0.0000 & 0.0757 & 0.0468 & 0.0186 & 7.86 & 0.81 \\
346 & 1.8974 & 1.8974 & 0.0000 & 0.0272 & 0.0441 & 0.0208 & 7.91 & 1.21 \\
545 & 3.3067 & 3.3067 & 0.0000 & 0.0429 & 0.0386 & 0.0202 & 7.90 & 1.51 \\
169 & 5.4602 & 5.4602 & 0.0000 & 0.0132 & 0.0459 & 0.0202 & 8.01 & 1.38 \\ \hline
\end{tabular}
\label{tab:evaluation7}
\newline

\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
\multicolumn{9}{|c|}{10 Routers}\\ \hline
$G$ & $f$ & $f_{AVG}$ & $\sigma_f$ & $t$ & $t_{AVG}$ & $\sigma_t$ & $T$ & $E$ \\ \hline
799 & 6.1032 & 6.1032 & 0.0000 & 0.0874 & 0.0605 & 0.0270 & 10.94 & 1.50 \\
458 & 3.3524 & 3.3524 & 0.0000 & 0.0510 & 0.0565 & 0.0294 & 10.96 & 1.04 \\
508 & 18.5925 & 18.5925 & 0.0000 & 0.0553 & 0.0619 & 0.0284 & 11.02 & 1.57 \\
567 & 0.9153 & 0.9153 & 0.0000 & 0.0612 & 0.0606 & 0.0274 & 10.83 & 1.59 \\
776 & 2.2515 & 2.2515 & 0.0000 & 0.0858 & 0.0666 & 0.0275 & 10.97 & 1.05 \\ \hline
\end{tabular}
\label{tab:evaluation10}
\newline

\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
\multicolumn{9}{|c|}{20 Routers}\\ \hline
$G$ & $f$ & $f_{AVG}$ & $\sigma_f$ & $t$ & $t_{AVG}$ & $\sigma_t$ & $T$ & $E$ \\ \hline
520 & 9.7758 & 9.7758 & 0.0000 & 0.1105 & 0.1158 & 0.0587 & 21.04 & 1.31 \\
333 & 8.0590 & 8.0590 & 0.0000 & 0.0706 & 0.1199 & 0.0558 & 21.18 & 1.34 \\
555 & 13.4780 & 13.4780 & 0.0000 & 0.1169 & 0.1132 & 0.0584 & 21.05 & 0.91 \\
228 & 23.2258 & 23.2258 & 0.0000 & 0.0474 & 0.1151 & 0.0542 & 21.05 & 1.03 \\
98 & 8.1096 & 8.1096 & 0.0000 & 0.0208 & 0.1081 & 0.0550 & 20.78 & 0.97 \\ \hline
\end{tabular}
\label{tab:evaluation20}
\newline

\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
\multicolumn{9}{|c|}{50 Routers}\\ \hline
$G$ & $f$ & $f_{AVG}$ & $\sigma_f$ & $t$ & $t_{AVG}$ & $\sigma_t$ & $T$ & $E$ \\ \hline
636 & 39.0652 & 39.0653 & 0.0000 & 0.3241 & 0.2683 & 0.1371 & 50.77 & 0.20 \\
819 & 31.9775 & 31.9775 & 0.0000 & 0.4685 & 0.2835 & 0.1309 & 51.07 & 1.28 \\
125 & 29.3588 & 29.3588 & 0.0000 & 0.0629 & 0.2444 & 0.1349 & 50.39 & 1.03 \\
694 & 31.5268 & 31.5268 & 0.0000 & 0.3537 & 0.2744 & 0.1407 & 50.49 & 1.34 \\
843 & 36.3826 & 36.3826 & 0.0000 & 0.4247 & 0.2577 & 0.1302 & 50.73 & 1.40 \\ \hline
\end{tabular}
\label{tab:evaluation50}
\newline

\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|} \hline
\multicolumn{9}{|c|}{100 Routers}\\ \hline
$G$ & $f$ & $f_{AVG}$ & $\sigma_f$ & $t$ & $t_{AVG}$ & $\sigma_t$ & $T$ & $E$ \\ \hline
564 & 53.0036 & 53.0037 & 0.0000 & 0.5636 & 0.5590 & 0.2641 & 100.42 & 1.08 \\
739 & 62.1487 & 62.1488 & 0.0000 & 0.7380 & 0.5247 & 0.2520 & 100.10 & 1.21 \\
313 & 93.6970 & 93.6970 & 0.0000 & 0.3131 & 0.4912 & 0.2844 & 100.79 & 1.14 \\
276 & 56.3132 & 56.3133 & 0.0000 & 0.2746 & 0.5312 & 0.2559 & 100.36 & 1.19 \\
288 & 67.7403 & 67.7403 & 0.0000 & 0.2911 & 0.5335 & 0.2550 & 101.14 & 1.24 \\ \hline
\end{tabular}
\label{tab:evaluation100}
\end{table}
...
Todas las soluciones obtenidas son aceptables considerando la aplicación que motiva el algoritmo y las dimensiones del espacio de búsqueda, presentando un error promedio de 1,26m respecto a la posición real del dispositivo.\\
...
Parece primar la imprecisión intrínseca del modelo elegido, no pudiendo mejorar arbitrariamente la precisión, como se había predecido en un principio. Las atenuaciones en las señales ocasionan un corriendo el punto en el que la función de fitness se minimiza por lo que aún cuando el algoritmo alcanza el óptimo, éste no se corresponda exactamente con la posición real del dispositivo.\\
...
Como se evidencia para varias de las instancias de prueba, el algoritmo fue capaz de encontrar una buena aproximación. Si bien esta aproximación está limitada por incertidumbres en las mediciones y sesgada por el modelo de propagación de ondas usado, se demostró la posibilidad de triangular dispositivos móviles en tiempos reducidos.\\

Concluimos que un enfoque como el presentado aquí perfectamente puede ser usado en la práctica si se cuenta con al menos tres routers de los cuales sí se conoce su ubicación, en especial si el contexto en el que se usa presenta atenuaciones menores a 2dBm o la aplicación no requiere de una precisión mayor a 1,5m.\\
