...
namespace newGA {
            ...
            switch (nb_section) {
                case 0: switch (nb_param) {
                        case 0: setup.independent_runs(op);
                            break;
                        case 1: setup.nb_evolution_steps(op);
                            break;
                        case 2: setup.population_size(op);
                            break;
                        case 3: setup.population_additional_size(op);
                            break;
                        case 4: setup.combine(op);
                            break;
                        case 5: setup.display_state(op);
                            break;
                    }
                    nb_param++;
                    break;
                ...
                case 4: if (nb_LAN_param >= 3) break;
                    switch (nb_LAN_param) {
                        case 0: setup.refresh_global_state(op);
                            break;
                        case 1: setup.synchronized(op);
                            break;
                        case 2: assert(op > 0);
    ...
    const double SetUpParams::fitness_treshold() const {
        return _fitness_treshold;
    }
    ...
    struct individual Selection::select_one(const Rarray<Solution*>& to_select_1, const Rarray<Solution*>& to_select_2, const Rarray<struct individual>& fitness_values, const unsigned int dummy, const bool remplace) const { // select a random individual	
    ...
    ostream& operator<<(ostream& os, const Selection& sel) {
        switch (sel.number_selection()) {
            case 0: os << "Random Selection";
                break;
            case 1: os << (Selection_Tournament&) sel;
                break;
            case 2: os << (Selection_Roulette_Wheel&) sel;
                break;
            case 3: os << (Selection_Rank&) sel;
                break;
            case 4: os << (Selection_Best&) sel;
                break;
            case 5: os << (Selection_Worst&) sel;
                break;
        }
        return os;
    }
