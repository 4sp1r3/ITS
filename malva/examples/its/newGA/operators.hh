...
namespace newGA {
    ...
    class Crossover : public Intra_Operator {
    public:
        Crossover();
        virtual ~Crossover();
    ...
    class Mutation : public Intra_Operator {
    public:
        Mutation();
        virtual ~Mutation();
    ...
    class Migration : public Inter_Operator {
    public:
    ...
    class Selection_Tournament : public Selection {
    public:
    ...
    class Selection_Roulette_Wheel : public Selection {
    public:
    ...
    class Selection_Rank : public Selection {
    public:
    ...
    class Selection_Best : public Selection_Rank {
    private:
    ...
    class Selection_Worst : public Selection_Rank {
    private:
