...
struct smanip1c // "const int"
{
    ...
    smanip1c(NetStream & (*ff)(NetStream&, const int), int ii) : f(ff), i(ii) {
    } // Constuctor
};
...
struct smanip1 // "int*"	note: references do not work! "int&"
{
    ...
    smanip1(NetStream & (*ff)(NetStream&, int*), int* ii) : f(ff), i(ii) {
    } // Constuctor
};
...
public:
    ...
    NetStream& operator<<(double d);
    NetStream& operator>>(char* d);
    /*NULL terminated*/ NetStream& operator<<(char* d);
    NetStream& operator>>(void* d);
    /*NULL terminated*/ NetStream& operator<<(void* d);
    // Extended data types from version 1.5 on
    NetStream& operator>>(unsigned char& d);
    NetStream& operator<<(unsigned char d);
    NetStream& operator>>(unsigned short int& d);
    NetStream& operator<<(unsigned short int d);
    NetStream& operator>>(unsigned int& d);
    NetStream& operator<<(unsigned int d);
    NetStream& operator>>(unsigned long int& d);
    NetStream& operator<<(unsigned long int d);
    NetStream& operator>>(long double& d);
    NetStream& operator<<(long double d);
    ...
    NetStream& operator<<(NetStream& (*f)(NetStream& n)) {
        return f(*this);
    } // NO arguments
    ...
    NetStream& operator<<(smanip1c m) {
        return m.f((*this), m.i);
    }// ONE int& argument constant
    // "int*"

    NetStream& operator<<(smanip1 m) {
        return m.f((*this), m.i);
    }// ONE int& argument
